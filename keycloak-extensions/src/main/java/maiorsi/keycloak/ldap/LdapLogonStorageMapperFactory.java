...
public final class LdapLogonStorageMapperFactory extends AbstractLDAPStorageMapperFactory {
    private static final String PROVIDER_ID = "logon-ldap-mapper";
    private static final List<ProviderConfigProperty> configProperties = new ArrayList<>();

    public LdapLogonStorageMapperFactory() {}
    ...
    protected AbstractLDAPStorageMapper createMapper(
        ...
        return new LdapLogonStorageMapper(mapperModel, federationProvider);
    }
